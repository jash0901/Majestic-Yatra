...
<a class="button grey" href="#" style="float: right; margin-top: 0.5%;">Update Profile Picture</a>
<a class="button grey" href="#" style="float: right; margin-top: 0.5%;">Update Profile</a>
<a class="button grey" href="Gallery.php" style="float: right; margin-top: 0.5%;">Update Gallery</a>
<?php
$id = $_SESSION['id'];
...
<p>This is a bio</p>
<span class="iq-tw-6"><a href="#"> <span class="__cf_email__">[Update your bio]</span></a></span>
</div>
<?php
$str = "select * from user_master where u_id = $id";
$result = mysqli_query($conn,$str);
