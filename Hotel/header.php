						...
						<div class="col-sm-12">
							...
							<ul class="menu-sidebar pull-right">
								...
								<ul class="menu-links">
									...
									<li><a href="profile.php">Destinations</a>
										<ul class="drop-down-multilevel">
											<li><a href="javascript:void(0)">Add a Destination<i class="fa fa-angle-right fa-indicator"></i> </a>
											</li>
											<li><a href="javascript:void(0)">View Destinations Trips<i class="fa fa-angle-right fa-indicator"></i> </a>
											</li>
										</ul>
									</li>
