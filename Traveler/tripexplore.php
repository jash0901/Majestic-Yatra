...
//cond =  and tr_from	> sysdate
$str = "select * from trip_master where tr_dest $source and tr_from > sysdate() limit $previousRows, $rowsPerPage";
...
<div class="container" style="height: 100%;width: 100%;">
	...
	<div class="card" style="height: 30%;margin-top: 50px;">
		<div class="card-header">
			...
			<?php		$source = explode(',',$data['tr_source']);
		$cnid = $source[0];
		if (isset($source[1])) {
			$sid = $source[1];
		}else {$sid = -1;}
		...
		$source1 = implode(', ', $arr2);
			...
			<div class="card-body" style="height: 100%;">
				...
				<br><p style="margin-top: 10px;"><Strong>Source: <?= $source ?></Strong></p>
				<p style=""><Strong>Destination: <?= $source1 ?></Strong></p>
