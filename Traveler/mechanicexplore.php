...
<div class="container">
	<div class="row align-items-center">
		<div class="col-lg-8">
			<div class="iq-mb-0">
				<h2 class="iq-font-white iq-tw-6" style="margin-top: 10%;">View Mechanics</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="main-content">
	...
	<center>
		<form action="mechanicexplore.php" method="post" enctype="multipart/form-data">
		...
		<center><button style="height:30%; width: 70%;font-size: 20px;" class="button iq-mr-0" name="btn" style="font-size: 20px;"><b>Find Mechanic Assistance</b></button></center>
	</form>
	<br>
</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="row">
						<?php 
							extract($_POST);
							$str1 = "select m_id,mechanic_master.u_id,u_name,email,u_phone,u_pic,garage_addr,fees,mechanic_master.verified from user_master,mechanic_master where user_master.u_type='Mechanic' and (user_master.city_id = '$cityid' and user_master.state_id = '$stateid' and user_master.country_id = '$cntryid') and mechanic_master.allocated = 0 and mechanic_master.verified = 1 and user_master.u_id = mechanic_master.u_id";
							...
							<div class="item">
								<div class="iq-productbox">
									<div class="product-image">
										<img class="hover" src="../profilepics/<?= $pic ?>" style="height: 250px;" alt="Mechanic image">
									</div>
									<div class="product-detail">
										<h6><a href="viewmechanicprofile.php?mechanicid=<?= $did ?>&userid=<?= $uid ?>"><?= $data1['u_name'] ?></a></h6>
										<p><?= $data1['garage_addr'] ?></p>
