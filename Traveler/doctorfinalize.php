...
if ($trip == -1) {
 ...
 $str = "insert into doctor_request_master (u_id,tr_id,d_id,address,approved,req_date) values ('$uid','$trip','$did','$address','A','$reqdate')";
...
<h5 class="iq-tw-5 iq-mb-10 iq-mt-40">Doctor is being notified.</h5>
<p>You will be notified and contacted by doctor when he accepts your request. KEEP TRAVELLING!!</p>
<div class="iq-mt-30">
