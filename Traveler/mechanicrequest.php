...
<div class="container">
	<div class="row align-items-center">
		<div class="col-lg-8">
			<div class="iq-mb-0">
				<h2 class="iq-font-white iq-tw-6" style="margin-top: 50px;">Mechanic Finalize</h2>
			</div>
		</div>
	</div>
</div>
...
<h2 class="title iq-tw-6 iq-font-white">Mechanic Finalize</h2>
</div>
</div>
</div>
...
<form action="mechanicfinalize.php" method="POST">
<div class="form-group">
<?php 
$str = "select user_master.u_id,u_name from user_master,mechanic_master where user_master.u_id = (select u_id from mechanic_master where m_id = $mid)";
$res = mysqli_query($conn,$str);
$data = mysqli_fetch_array($res);
 ?>
<label class="iq-font-white" for="username">Are you sure you want to request the mechanic:</label><br>
<label class="iq-font-white" for="username">Mechanic Name: <?= $data['u_name'] ?></label><br>
...
<button type="submit" class="button iq-mt-40" name="submit"><b>Yes Request Mechanic Assistant Now.</b></button>
