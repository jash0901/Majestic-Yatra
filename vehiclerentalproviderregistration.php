...
<head>
<title>Vehicle Rental Provider-Register</title>
...
<h2 class="title iq-tw-6 iq-font-black">Vehicle Rental Provider Register</h2>
</div>
</div>
</div>
...
<form class="login-form" action="vehrentalregprocess.php" method="post" enctype="multipart/form-data">
       ...
       <?php
        ...
        ?>
          ...
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" name="btn"><i class="fa fa-sign-in fa-lg fa-fw"></i>Register as Vehicle Rental Provider</button>
          <?php
