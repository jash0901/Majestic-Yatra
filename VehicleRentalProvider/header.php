<?php session_start(); 
require "../lib/vrploginvalidation.php";  ?>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../profilepics/<?= $_SESSION['pic'] ?>" style="height: 60px;width: 60px;" alt="User Image">
        <div>
          ...
          <p class="app-sidebar__user-designation">Vehicle Rental Provider</p>
        </div>
      </div>
      <ul class="app-menu">
        <li><a class="app-menu__item" href="viewvehicle.php"><i class="app-menu__icon fa fa-road"></i><span class="app-menu__label">View Added Vehicles </span></a></li>
        <li><a class="app-menu__item" href="addvehicle.php"><i class="app-menu__icon fa fa fa-road"></i><span class="app-menu__label">Add a vehicle</span></a></li>
          </ul>
        </li>
      </ul>
    </aside>
