  <?php require "header.php"; ?>
    <main class="app-content">
      ...
      <div class="row">
        <?php 
        $uid = $_SESSION['id'];
        $str = "select d_id,allocated from doctor_master where u_id = $uid";
        ...
        <?php            exit (); }
        $did = $data['d_id'];
        $str1 = mysqli_query($conn,"select * from doctor_request_master where d_id = $did and req_date>sysdate() and approved = 'A'");
         ...
         ?>
          ...
          <div class="tile">
            ...
            <div class="tile-body">Request Date: <?= $data1['req_date'] ?><br>
              ...
              User_Phone: <?= $data2['u_phone'] ?><br>
              Gender: <?= $data2['gender'] ?></div>
            <div class="tile-footer" style=""><a class="btn btn-primary" href="reqaccept.php?reqid=<?= $data1['dr_req_id'] ?>">Accept Request</a></div>
          </div>
        </div>
      <?php 
    }
