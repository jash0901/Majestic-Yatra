...
<!-- Mirrored from iqonicthemes.com/themes/qwilo/register-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Dec 2018 07:01:27 GMT -->
<head>
...
<h2 class="title iq-tw-6 iq-font-white">Traveler-Register</h2>
</div>
</div>
</div>
      ...
      <div class="form-group">
        ...
        ?>
          ...
          <div class="form-group">
                    ...
                    <input class="form-control" name="dte" type="date">
                     <?php
        ...
        ?>
          ...
          <button class="btn btn-primary btn-block" name="btn"><i class="fa fa-sign-in fa-lg fa-fw"></i>Register as Traveler</button>
            <?php
...
<div class="iq-font-white iq-tw-6">Already Have an Account?</div><a href="#" class="iq-font-green iq-tw-6 link">Login</a>
</div>
</div>
</div>
</div>
