...
<h2 class="title iq-tw-6 iq-font-black">Hotel-Register</h2>
</div>
</div>
</div>
...
<form class="login-form" action="hotelregistrationprocess.php" id="myform" method="post" enctype="multipart/form-data">
       ...
       <?php
        ...
        ?>
          ...
          <div class="form-group">
                  ...
                  <textarea class="form-control" name="address" placeholder="Max 75 charactered Address" maxlength="75" style="resize: none; height: 150px;"></textarea>
          <?php
        ...
        ?>
         ...
         <div class="form-group" style="margin-bottom: 20px;">
                  <label class="control-label">License Proof</label>
                  <input class="form-control" name="idproof" required type="file">
        ...
        ?>
          ...
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" name="btn"><i class="fa fa-sign-in fa-lg fa-fw"></i>Register as Hotel</button>
        <?php
